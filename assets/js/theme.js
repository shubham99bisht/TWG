...
function identifyCurrentPage() {
  ...
  switch(pageName) {
    case "portfolio.html":
      document.getElementById("portfolio-nav").click();
      switch(window.location.hash) {
        case '#token': 
          document.getElementById("token-nav").classList.add('active');
          break;
        case '#nft': 
          document.getElementById("nft-nav").classList.add('active');
          break;
        case '#defi': 
          document.getElementById("defi-nav").classList.add('active');
      }
      break;
    case "crypto.html":
    case "nft.html":
      document.getElementById("market-nav").click();
      break;
    case "compare.html":
    case "converter.html":
    case "gas.html":
        document.getElementById("tools-nav").click();
        break;
  }
}
...
// Load Topbar from dedicated HTML file
fetch('topbar.html')
.then(res => res.text())
.then(text => {
