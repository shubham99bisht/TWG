...
universityForm.addEventListener('submit', function (event) {
  ...
  try {
    ...
    const data = {
      ...
      billing: {
        accountName: inputsAndSelects[1].value,
        accountNumber: inputsAndSelects[2].value,
        bankName: inputsAndSelects[3].value,
        ifsc: inputsAndSelects[4].value,
      },
      programTypes: []
    };
    ...
    for (let i = 5; i < inputsAndSelects.length; i++) {
  ...
  // TODO: 
  // 3. Support updating universities
});
